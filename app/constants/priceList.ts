export interface IpriceList {
  ...
  export const priceList: IpriceList[] = [
    ...
    { title: "Замена каблуков мужские", description: "пара", price: "1700р" },
    { title: "Крепление каблука", description: "шт", price: "500р" },
    { title: "Перетяжка кожи на каблуке", description: "шт", price: "200р" },
    { title: "Восстановление полосок на каблуке", description: "шт", price: "200,00р." },
    { title: "Замена подошвы", description: "пара", price: "3000р" },
    { title: "Замена супинатора", description: "шт", price: "750р" },
    { title: "Замена молнии", description: "шт", price: "от 500р" },
    { title: "Замена “бегунка” на молнии", description: "шт", price: "от 250р" },
    { title: "Проклейка подошвы круговая", description: "пара", price: "1000р" },
    { title: "Прошив подошвы круговой", description: "пара", price: "1400р" },
  ...
  { title: "Укорочивание голенища", description: "пара", price: "от 1500р" },
  { title: "Врезка молнии", description: "шт", price: "100р" },
  ...
  { title: "Накат на всю подошву п/у", description: "пара", price: "от 1000р" },
